    ...
    <React.Fragment>
      <div className="gemstone-form visible">
        <form onSubmit={onSubmit}>
          ...
          <div className="image">
            <div className="image-manipulation"><input ref={imageRef} id="image" name="image" type="file" accept="image/*" placeholder="Choose a gemstone picture" onChange={onImageChange} /><canvas ref={canvasRef} id="image-preview" width="128" height="128"></canvas></div>
